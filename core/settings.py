...
SECRET_KEY = "django-insecure-^&-)c7yli-cemd=zs_me4x=!4dx%*%7!6^-6dm4^#t)1@m0!p+"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1','89.23.112.178', 'america.akmal.webtm.ru']
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Добро пожаловать в American Dream Osh Admin-Panel",

    # Copyright on the footer
    "copyright": "Akmal Madakimov-American Dream Osh",
    ...
    "usermenu_links": [
        {"model": "auth.user"},
        {"name": "Открыть сайт American Dream Osh",  "url": "/"},
    ],
